...
DROP TABLE IF EXISTS `t_bu_base_user`;

CREATE TABLE `t_bu_base_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `code` varchar(200) DEFAULT NULL COMMENT '登陆账号',
  `password` varchar(200) DEFAULT NULL COMMENT '登陆密码',
  `ct` datetime DEFAULT NULL,
  `ut` datetime DEFAULT CURRENT_TIMESTAMP,
  `cid` bigint(11) DEFAULT NULL,
  `uid` bigint(11) DEFAULT NULL,
  `ava` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户基础表';

/*Data for the table `t_bu_base_user` */

insert  into `t_bu_base_user`(`id`,`code`,`password`,`ct`,`ut`,`cid`,`uid`,`ava`) values (1,'13544361981','123456','2019-10-30 11:05:29','2019-10-30 11:05:36',1,1,1);

/*Table structure for table `t_bu_hospital` */

DROP TABLE IF EXISTS `t_bu_hospital`;

CREATE TABLE `t_bu_hospital` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `area` int(11) DEFAULT NULL COMMENT '县(区)',
  `type` tinyint(4) DEFAULT '0' COMMENT '0:综合 1:肿瘤 2:心脑血',
  `grade` tinyint(4) DEFAULT '2' COMMENT '等级 0:卫生院 1:一甲 2:二甲',
  `status` tinyint(4) DEFAULT '1' COMMENT '状态 0:无效 1:有效',
  `ct` datetime DEFAULT NULL,
  `ut` datetime DEFAULT NULL,
  `cid` bigint(20) DEFAULT NULL,
  `uid` bigint(20) DEFAULT NULL,
  `ava` tinyint(4) DEFAULT '1' COMMENT '1：有效 0：无效',
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `t_bu_user_account`;

CREATE TABLE `t_bu_user_account` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) NOT NULL COMMENT 't_bu_base_user表id',
...
/*Data for the table `t_bu_user_account` */

/*Table structure for table `t_bu_user_info` */

DROP TABLE IF EXISTS `t_bu_user_info`;

CREATE TABLE `t_bu_user_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) NOT NULL COMMENT '基本用户表id',
  `user_name` varchar(200) CHARACTER SET latin1 DEFAULT NULL COMMENT '用户名称',
  ...
  `cid` bigint(20) DEFAULT NULL,
  `uid` bigint(20) DEFAULT NULL,
  `ava` tinyint(4) DEFAULT '1' COMMENT '0:无效 1:有效',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `t_bu_user_info` */
...
CREATE TABLE `t_sys_params` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL DEFAULT '0',
  `params_key` varchar(50) NOT NULL COMMENT 'key值',
  `params_value` varchar(200) NOT NULL COMMENT 'value值',
  `params_desc` varchar(200) DEFAULT NULL COMMENT '参数描述',
  `leaf` tinyint(4) DEFAULT '1' COMMENT '0:不是叶子节点 1:是',
...
insert  into `t_sys_params`(`id`,`pid`,`params_key`,`params_value`,`params_desc`,`leaf`,`status`) values (1,0,'service-phone','13544361981','客服电话',1,1);
...
CREATE TABLE `t_sys_role_permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='角色权限中间关联表';

/*Data for the table `t_sys_role_permission` */

insert  into `t_sys_role_permission`(`id`,`sys_role_id`,`sys_permission_id`) values (2,1,1);
...
CREATE TABLE `t_sys_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `usercode` varchar(200) DEFAULT NULL COMMENT '用户编码',
